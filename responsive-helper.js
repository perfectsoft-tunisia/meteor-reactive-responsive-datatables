 ...
 */
export function ResponsiveDatatablesHelper(tableSelector, breakpoints, options) {
...
ResponsiveDatatablesHelper.prototype.getState = function () {
    if (typeof(Storage)) {
        // Use local storage
        var value = JSON.parse(window.localStorage.getItem(this.cookieName));
        if (value) {
...
ResponsiveDatatablesHelper.prototype.setState = function () {
    if (typeof(Storage)) {
        ...
        if (d1 + d2 > 0) {
            ...
            window.localStorage.setItem(this.cookieName, JSON.stringify(value));
